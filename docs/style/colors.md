...
| Sage               | `#5E6F53`                         | `sage`                                      | Accent / eyebrow color only. Section eyebrows, timeline dates. Small and rare — never large fills, never CTAs. Tuned to clear WCAG AA contrast on cream at small sizes.                                                                             |
