                ...
                <div className="mx-auto max-w-5xl px-6 py-20">
                    ...
                    <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        {checklist.map((item, index) => {
                            ...
                            return (
                                <Reveal key={item.heading.de} delayMs={index * 80}>
                            ...
                            <div key={group.heading.de}>
                                ...
                                <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                                    {group.items.map((service, index) => {
                                        ...
                                        return (
                                            <Reveal key={service.heading.de} delayMs={index * 80}>
                                                <article className="group h-full rounded-xl border border-aubergine/10 bg-cream p-6 transition-[transform,border-color,box-shadow] duration-300 ease-out hover:-translate-y-0.5 hover:border-gold hover:shadow-md">
                    ...
                    >
                        ...
                        <ol className="mt-8 grid max-w-3xl gap-5">
                            {bringList.map((item, index) => (
                                <Reveal key={item.heading.de} as="li" delayMs={index * 80} className="flex gap-4">
                                    <span
