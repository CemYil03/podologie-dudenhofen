...
export const LEISTUNGEN_CHECKLIST: ReadonlyArray<ContentLeaf> = [
    ...
    },
    {
        ...
        icon: ScissorsIcon,
        heading: {
            de: 'Eingewachsene oder verformte Nägel',
            en: 'Ingrown or deformed nails',
            ru: 'Вросшие или деформированные ногти',
            ar: 'أظافر غارزة أو مشوهة',
        },
        body: {
            de: 'Nägel, die in die Haut wachsen oder ihre Form verloren haben.',
            en: 'Nails that grow into the skin or have lost their shape.',
            ru: 'Ногти, врастающие в кожу или утратившие свою форму.',
            ar: 'أظافر تنمو داخل الجلد أو فقدت شكلها الطبيعي.',
        },
        keywords: {
            de: ['eingewachsen', 'nagel', 'nägel', 'unguis incarnatus', 'verformt'],
            en: ['ingrown', 'nail', 'nails', 'deformed'],
            ru: ['вросший', 'ноготь', 'ногти', 'unguis incarnatus', 'деформированный'],
            ar: ['غارز', 'ظفر', 'أظافر', 'unguis incarnatus', 'مشوه'],
        },
    },
    {
        ...
        icon: SparklesIcon,
        heading: {
            de: 'Hornhaut, Hühneraugen, Schwielen',
            en: 'Calluses, corns, hardened skin',
            ru: 'Натоптыши, мозоли, ороговевшая кожа',
            ar: 'تقرنات وعين السمكة وجلد متصلب',
        },
        body: {
            de: 'Verdickte Hautstellen, die drücken oder Schmerzen verursachen.',
            en: 'Thickened skin areas that press or cause pain.',
            ru: 'Утолщённые участки кожи, которые давят или вызывают боль.',
            ar: 'مناطق جلد سميكة تسبب الضغط أو الألم.',
        },
        keywords: {
            de: ['hornhaut', 'hühnerauge', 'hühneraugen', 'clavus', 'schwiele', 'schwielen'],
            en: ['callus', 'calluses', 'corn', 'corns', 'clavus', 'hardened skin'],
            ru: ['ороговевшая кожа', 'мозоль', 'мозоли', 'clavus', 'натоптыш', 'натоптыши'],
            ar: ['تقرن', 'عين السمكة', 'مسمار اللحم', 'clavus', 'جلد متصلب'],
        },
    },
    {
        ...
        icon: BugIcon,
        heading: {
            de: 'Pilzinfektionen an Nagel oder Haut',
            en: 'Fungal nail or skin infections',
            ru: 'Грибковые инфекции ногтей или кожи',
            ar: 'عدوى فطرية في الأظافر أو الجلد',
        },
        body: {
            ...
            ru: 'Изменённые в цвете, ломкие ногти или зудящие участки кожи на стопе.',
            ar: 'أظافر متغيرة اللون وهشة أو بقع جلدية مثيرة للحكة في القدم.',
        },
        keywords: {
            ...
            ru: ['грибок', 'грибки', 'грибковая инфекция', 'микоз', 'микозы', 'онихомикоз', 'грибок стопы'],
            ar: ['فطر', 'فطريات', 'عدوى فطرية', 'فطار', 'فطار الأظافر', 'فطار القدم'],
        },
    },
    {
        id: 'check-verordnung',
